...
find_library( LIBCASM_TC_TEST
  NAMES libcasm-tc-test
  PATHS ${LIBCASM_TC_PKGCONF_LIBRARY_DIRS}
)

find_library( LIBCASM_TC_BENCHMARK
  NAMES libcasm-tc-benchmark
  PATHS ${LIBCASM_TC_PKGCONF_LIBRARY_DIRS}
)

set( LIBCASM_TC_PROCESS_INCLUDES LIBCASM_TC_INCLUDE_DIR )
set( LIBCASM_TC_PROCESS_LIBS     LIBCASM_TC_LIBRARY LIBCASM_TC_TEST LIBCASM_TC_BENCHMARK )
...
set( LIBCASM_TC_ARCHIVE ${LIBCASM_TC_LIBRARY} PARENT_SCOPE )
