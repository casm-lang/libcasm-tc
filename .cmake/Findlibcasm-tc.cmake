...
find_library( LIBCASM_TC_LIBRARY
  NAMES libcasm-tc.so libcasm-tc.dylib libcasm-tc.dll
  PATHS ${LIBCASM_TC_PKGCONF_LIBRARY_DIRS}
)

find_library( LIBCASM_TC_ARCHIVE
  NAMES libcasm-tc.a
  PATHS ${LIBCASM_TC_PKGCONF_LIBRARY_DIRS}
)
...
set( LIBCASM_TC_PROCESS_LIBS     LIBCASM_TC_LIBRARY LIBCASM_TC_ARCHIVE )
...
if( EXISTS "${LIBCASM_TC_LIBRARY}"   AND ${LIBCASM_TC_LIBRARY} AND
    EXISTS "${LIBCASM_TC_ARCHIVE}"   AND ${LIBCASM_TC_ARCHIVE} AND
