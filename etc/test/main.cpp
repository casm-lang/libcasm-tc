...
TEST( libcasm_tc_main, empty )
{
    std::cout << libcasm_tc::REVTAG << "\n";
    std::cout << libcasm_tc::COMMIT << "\n";
    std::cout << libcasm_tc::BRANCH << "\n";
    std::cout << libcasm_tc::LICENSE << "\n";
    std::cout << libcasm_tc::NOTICE << "\n";
}
